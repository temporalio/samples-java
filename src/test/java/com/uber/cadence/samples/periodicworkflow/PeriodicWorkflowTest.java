...
public class PeriodicWorkflowTest {
    ...
    public void setUp() throws Exception {
        ...
        workflowTest.addActivitiesImplementation(PeriodicWorkflowWorker.TASK_LIST, periodicActivitiesImplementation);
        errorReportingActivitiesImplementation = new TestErrorReportingActivities();
        workflowTest.addActivitiesImplementation(PeriodicWorkflowWorker.TASK_LIST, errorReportingActivitiesImplementation);
