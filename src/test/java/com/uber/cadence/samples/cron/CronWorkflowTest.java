 ...
 */
package com.uber.cadence.samples.cron;

import java.util.concurrent.CancellationException;

import com.amazonaws.services.simpleworkflow.flow.ActivityOptions;
...
public class CronWorkflowTest {
    ...
    public void setUp() throws Exception {
        ...
        workflowTest.addActivitiesImplementation(CronWorker.TASK_LIST, cronActivitiesImplementation);
...
//        activityType.setVersion("1.0");
        ...
        options.setTaskList(CronWorker.TASK_LIST);
