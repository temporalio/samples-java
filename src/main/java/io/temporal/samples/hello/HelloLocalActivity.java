...
public class HelloLocalActivity {
  ...
  /** Local Activity interface is the same as a non local one. */
  @ActivityInterface
  ...
  public static class GreetingWorkflowImpl implements GreetingWorkflow {
    ...
    /**
     * Local activity stub implements activity interface and proxies calls to it to Temporal
     * activity invocations. Because activities are reentrant, only a single stub can be used for
  ...
  public static void main(String[] args) {
    ...
    // Disable non local activity worker. Do it only if there is no need to execute non local
    // activities by this worker.
