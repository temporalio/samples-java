...
public class PropertiesContextPropagator implements ContextPropagator {
  @Override
  ...
  public Object getCurrentContext() {
    ...
    for (String key : PropertiesContext.getProperties().stringPropertyNames()) {
      context.put(key, PropertiesContext.get(key));
    }
  ...
  public void setCurrentContext(Object context) {
    ...
    for (Map.Entry<String, String> entry : contextMap.entrySet()) {
      {
        PropertiesContext.put(entry.getKey(), entry.getValue());
      }
    }
  }
}
