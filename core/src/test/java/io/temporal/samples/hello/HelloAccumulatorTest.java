...
public class HelloAccumulatorTest {
  ...
  public void testMultipleGreetings() {
    ...
    workflow.waitforGreeting(new Greeting("XVX Robot", bucket, "1123581321"));
    workflow.waitforGreeting(new Greeting("Han Robot", bucket, "112358"));
  ...
  public void testDuplicateGreetings() {
    ...
    workflow.waitforGreeting(new Greeting("XVX Robot", bucket, "1123581321"));
    workflow.waitforGreeting(new Greeting("Han Robot", bucket, "1123581321"));
  ...
  public void testWrongBucketGreeting() {
    ...
    workflow.waitforGreeting(new Greeting("Bad Robot", "orange", "1123581321"));
    workflow.waitforGreeting(new Greeting("XVX Robot", bucket, "11235"));
