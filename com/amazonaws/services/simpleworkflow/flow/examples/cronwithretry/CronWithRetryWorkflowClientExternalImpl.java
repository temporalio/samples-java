...
class CronWithRetryWorkflowClientExternalImpl extends WorkflowClientExternalBase implements CronWithRetryWorkflowClientExternal {

    public CronWithRetryWorkflowClientExternalImpl(WorkflowExecution workflowExecution, WorkflowType workflowType, 
            StartWorkflowOptions options, DataConverter dataConverter, GenericWorkflowClientExternal genericClient) {
        super(workflowExecution, workflowType, options, dataConverter, genericClient);
    }

    @Override
    public void startCron(com.amazonaws.services.simpleworkflow.flow.examples.cronwithretry.CronWithRetryWorkflowOptions options) { 
        startCron(options, null);
    }

    @Override
    public void startCron(com.amazonaws.services.simpleworkflow.flow.examples.cronwithretry.CronWithRetryWorkflowOptions options, StartWorkflowOptions startOptionsOverride) {
