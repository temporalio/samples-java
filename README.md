...
used for sample brevity and is not something we recommend for real applications.
  ...
  * **[HelloLocalActivity](https://github.com/temporalio/samples-java/blob/master/src/main/java/io/temporal/samples/hello/HelloLocalActivity.java)**: a workflow with a [local activity](https://docs.temporal.io/docs/concept-activities/#local-activities)
